...
Write-Host "  3. Run: .\start-app.bat --debug  (or: npx tsx server.ts)" -ForegroundColor White
Write-Host ""
Write-Host "💡 Tip: You can customize performance monitoring thresholds in .env" -ForegroundColor Gray
Write-Host "   See docs/operations.md and .env.example for details" -ForegroundColor Gray
Write-Host ""
